...
class H5VotesDataset(Dataset):
    ...
    def __init__(self, h5_path, split="train", use_all_sigmas=True, sigma_indices=None,
        ...
        # Optional normalization: if the dataset meta says normalize was used for classifier,
        # we often normalize the *clean* image fed to the certifier for stability.
        self.normalize = None
